...
public class SiteIncomeBean {
    ...
    /**
     * data : {"total":"13.00","sm_price":"4.00","tb_price":"9.00"}
     * data_m : {"dj_price":18,"tb_nums":18,"device_nums":1}
     * yesterday_data : {"sm_price":0,"tb_price":0,"price":"0.00"}
     * today_data : {"sm_price":0,"tb_price":0,"price":"0.00"}
     * thismonth_data : {"sm_price":0,"tb_price":0,"price":"0.00"}
    ...
    public static class DataMBean {
        ...
        public void setDj_price(int dj_price) {
            this.dj_price = dj_price;
        }

        public int getTb_nums() {
            return tb_nums;
        }

        public void setTb_nums(int tb_nums) {
            this.tb_nums = tb_nums;
        }
