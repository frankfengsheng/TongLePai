...
public class AllIncomeCmd extends BaseHttpCmdCps {
...
//    public static final String K_USER_ID = "userid";
    ...
    public AllIncomeCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getMarkerAllIncome(getParams().getChildParams().get("body").toString());
    }
}
