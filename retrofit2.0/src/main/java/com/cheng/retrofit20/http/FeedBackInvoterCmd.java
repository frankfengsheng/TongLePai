...
public class FeedBackInvoterCmd extends BaseHttpCmd {
    ...
    public FeedBackInvoterCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getInvestorFeedBack(getParams().getParentParams());
    }
}
