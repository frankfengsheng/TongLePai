...
public class FieldListCmd extends BaseHttpCmd {
    ...
    public FieldListCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getFieldList(getParams().getParentParams());
    }
}
