...
public class MarkerCheckBillCmd extends BaseHttpCmd {
    ...
    public MarkerCheckBillCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getCheckinfoBill(getParams().getParentParams());
    }
}
