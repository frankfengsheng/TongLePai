...
public class AllFieldDeviceCmd extends BaseHttpCmd {
    ...
    public AllFieldDeviceCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getAllFieldDevice(getParams().getParentParams());
    }
}
