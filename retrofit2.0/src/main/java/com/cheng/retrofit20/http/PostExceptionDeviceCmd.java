 ...
 */
public class PostExceptionDeviceCmd extends BaseHttpCmd {
    ...
    public PostExceptionDeviceCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getPostExceptionDevice(getParams().getParentParams());
    }
}
