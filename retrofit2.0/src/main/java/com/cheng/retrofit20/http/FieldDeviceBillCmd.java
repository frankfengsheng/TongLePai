...
public class FieldDeviceBillCmd extends BaseHttpCmd {
    ...
    public FieldDeviceBillCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getFieldDeviceBill(getParams().getParentParams());
    }
}
