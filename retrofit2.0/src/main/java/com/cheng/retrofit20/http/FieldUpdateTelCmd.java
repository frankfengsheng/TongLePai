...
public class FieldUpdateTelCmd extends BaseHttpCmd {
    ...
    public FieldUpdateTelCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getFieldUpdate(getParams().getParentParams());
    }
}
