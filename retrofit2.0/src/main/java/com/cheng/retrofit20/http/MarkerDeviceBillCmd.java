...
public class MarkerDeviceBillCmd extends BaseHttpCmd {
    ...
    public MarkerDeviceBillCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getMarkerDeviceBill(getParams().getParentParams());
    }
}
