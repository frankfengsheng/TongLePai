...
public class FieldCheckBillCmd extends BaseHttpCmd {
    ...
    public FieldCheckBillCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getFieldCheckinfoBill(getParams().getParentParams());
    }
}
