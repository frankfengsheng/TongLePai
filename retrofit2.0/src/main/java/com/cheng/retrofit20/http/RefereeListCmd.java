...
public class RefereeListCmd extends BaseHttpCmd {
    ...
    public RefereeListCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getRefereeList(getParams().getParentParams());
    }
}
