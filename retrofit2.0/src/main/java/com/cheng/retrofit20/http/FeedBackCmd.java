...
public class FeedBackCmd extends BaseHttpCmd {
    ...
    public FeedBackCmd(Context context, RequestParams params) {
        super(context, params);
    }

    @Override
    protected Call<?> getCall() {
        return getApiService().getFeedBack(getParams().getParentParams());
    }
}
