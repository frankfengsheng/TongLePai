...
public class InvestorApplyDetailBinding implements IUiDataBinding<List<ApplyDetailUseData>,ApplyDetailData> {
    private ApplyDetailData mResult;
    private Context mContext;

    public InvestorApplyDetailBinding(ApplyDetailData result, Context context) {
        this.mResult = result;
