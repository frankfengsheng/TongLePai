...
public class MarkerCanApplyRequest extends BaseHttpRequest<CanApplyData> {
    ...
    public MarkerCanApplyRequest(Context context) {
    ...
    private RequestParams getParams() {
        ...
        parameters.putParams(MarkerCanApplyCmd.K_USER_ID, HttpConfig.newInstance(mContext).getUserid());
        parameters.putParams(MarkerCanApplyCmd.K_TOKEN, HttpConfig.newInstance(mContext).getAccessToken());
        return parameters;
    }

    private HttpCommand newHttpCommand() {
        HttpCommand httpCmd = new MarkerCanApplyCmd(mContext, getParams());
