...
public class ExceptionDeviceBinding implements IUiDataBinding<List<ExceptionDeviceData>,AllDeviceResult> {
    private AllDeviceResult mResult;
    private Context mContext;

    public ExceptionDeviceBinding(AllDeviceResult result, Context context) {
        this.mResult = result;
