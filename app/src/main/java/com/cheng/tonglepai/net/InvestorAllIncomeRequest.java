...
import com.cheng.retrofit20.http.InvestorAllIncomeCmd;
...
public class InvestorAllIncomeRequest extends BaseHttpRequest<InvestorAllIncomeData> {

    private Context mContext;

    public InvestorAllIncomeRequest(Context context) {
    ...
    private RequestParams getParams(String data) {
        ...
        parameters.putParams(InvestorAllIncomeCmd.BODY, data);
...
//        parameters.putParams(InvestorAllIncomeCmd.K_USER_ID, "426");
    ...
    private HttpCommand newHttpCommand(String data) {
        HttpCommand httpCmd = new InvestorAllIncomeCmd(mContext, getParams(data));
