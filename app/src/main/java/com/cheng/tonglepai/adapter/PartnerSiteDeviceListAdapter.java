...
public class PartnerSiteDeviceListAdapter extends BaseAdapter {
    private Context context;
    private List<PartnerSiteDeviceIncomeListBean.DataBean> mData = new ArrayList<>();

    public PartnerSiteDeviceListAdapter(Context context, List<PartnerSiteDeviceIncomeListBean.DataBean> mList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            convertView = View.inflate(context, R.layout.view_item_partner_device_list, null);
        ...
        if(!TextUtils.isEmpty(mData.get(position).getStore_name()))  holder.tv_siteName.setText(mData.get(position).getDevice_name());
