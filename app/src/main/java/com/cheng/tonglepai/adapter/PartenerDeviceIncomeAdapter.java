...
public class PartenerDeviceIncomeAdapter extends BaseAdapter {
    private Context context;
    private List<PartnerDeviceIncomeListBean.DataBean> mData = new ArrayList<>();

    public PartenerDeviceIncomeAdapter(Context context, List<PartnerDeviceIncomeListBean.DataBean> mList) {
