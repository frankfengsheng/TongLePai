...
public class PartnerSiteIncomeActivity extends TitleActivity implements BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    private void initView() {
        ...
        lvDetail.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(PartnerSiteIncomeActivity.this, PartnerDeviceIncomeListActivity.class);
    ...
    private void initData(){
        loadingDialog.show();
        new IncomeModle(this).PartnerSiteDeviceListIncomeInfo(deviceId, startTime, endTime, page+"", new IncomeModle.PartnerSiteDeviceListIncomeSucess() {
            @Override
