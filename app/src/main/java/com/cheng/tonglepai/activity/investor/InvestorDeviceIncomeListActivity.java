...
public class InvestorDeviceIncomeListActivity extends TitleActivity implements BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    private void initData(){
        loadingDialog.show();
        new IncomeModle(this).TZDeviceLiushuiInfo(deviceId, startTime, endTime, page+"", new IncomeModle.DeviceIncomeDetailSuccessCallback() {
            @Override
